...
## Steps 
### Backend local setup
![Project Photo](image/be-do2.png)

### Frontend local setup
![Project Photo](image/webapp.png)

### Push images to Docker Hub
![Project Photo](image/docker2.png)

### Push code to GitHub
![Project Photo](image/github5.png)
...
![Project Photo](image/be-do.png)
![Project Photo](image/fe-do.png)
